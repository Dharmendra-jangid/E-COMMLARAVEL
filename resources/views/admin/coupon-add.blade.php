...
<div class="main-content-inner">
    <div class="main-content-wrap">
        ...
        <div class="wg-box">
            <form action="{{route('admin.coupon.store')}}" method="POST" class="form-new-product form-style-1" >
                @csrf
                <fieldset class="name">
                ...
                <fieldset class="name">
                    ...
                    <input class="flex-grow" type="date" placeholder="Expiry Date" name="expiry_data" tabindex="0" value="{{old('expiry_data')}}" aria-required="true">
                </fieldset>
                @error('expiry_data')
                <span class="alert alert-danger text-center">{{$message}}</span>
