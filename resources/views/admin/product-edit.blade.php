                ...
                <div class="wg-box">
                    ...
                    <div class="cols gap22">
                        ...
                        <fieldset class="name">
                            ...
                            <input class="mb-10" type="text" placeholder="Enter quantity" name="quatity"
                                tabindex="0" value="{{ $product->quatity }}" aria-required="true">
                        </fieldset>
                        @error('quatity')
                            <span class="alert alert-danger text-center">{{ $message }}</span>
                        @enderror
                            ...
                            <div class="select mb-10">
                                <select class="" name="stock_status">
                                    <option value="instock"{{ $product->stock_status == 'instock' ? 'selected' : '' }}>
                                        InStock</option>
                                    <option
                                        value="outofstock"{{ $product->stock_status == 'outofstock' ? 'selected' : '' }}>Out
                                        of Stock</option>
                                </select>
                            </div>
                        </fieldset>
    ...
    <script>
        $(function() {
                    $('#myFile').on("change", function(e) {
                        ...
                        if (file) {
                            $("#imgpreview img").attr('src', URL.createOjectURL(file));
                            $("#imgpreview img").show();
                        }
                    });
