...
<head>
    ...
    <link rel="shortcut icon" href="{{asset('add-to-cart.png')}}">
    <link rel="apple-touch-icon-precomposed" href="{{asset('add-to-cart.png')}}">
                ...
                <div class="section-menu-left">
                    <div class="box-logo">
                        <a href="{{route('admin.index')}}" id="site-logo-inner">
                                ...
                                <h1 class="ecomm"><img src="{{asset('shopping-bag.png')}}" class="ecomm" alt=""> E-Comm</h1>
                                {{-- <img src="{{asset('assets/images/logo.png')}}" al  t="Uomo" class="logo__image d-block" /> --}}
...
-
                    ...
                    <div class="main-content">
                        ...
                        <div class="bottom-page">
                            <div class="body-text">Copyright © 2024 Dharmendra</div>
                        </div>
                    </div>
