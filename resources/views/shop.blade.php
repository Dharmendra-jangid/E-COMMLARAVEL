          ...
          <div class="accordion-item mb-4">
            ...
            <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
              ...
              <input class="price-range-slider" type="text" name="price_range" value="" data-slider-min="1"
                data-slider-max="500000" data-slider-step="5" data-slider-value="[{{$min_price}},{{$max_price}}]" data-currency="$" />
              <div class="price-range__info d-flex align-items-center mt-2">
                ...
                <div>
                  ...
                  <span class="price-range__max">500000</span>
                </div>
              </div>
            </div>
          </div>
...
<script>
    ...
    //  $("inputp[name='brands']").on("change",function(){
    //     $("inputp[name='brands']:checked").each(function(){
    //         if(brands == ""){
    //             brands += $(this).val();
    //         }
    //         else{
    ...
    let brands = ""; // Initialize 'brands' variable
...
$("input[name='categories']").on("change", function() {
    let categories = ""; // Initialize 'brands' variable
...
$("input[name='price_range']").on("change", function() {
    ...
    var max = values[1];
    $("#hdnMinPrice").val(min);
    $("#hdnMaxPrice").val(max); // Correct this line
    setTimeout(() => {
        $("#frmfilter").submit();
    }, 2000);
});
